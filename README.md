...
- [ ] processo master
    ...
    - [x] far partire *alimentatore*
    - [x] STAMPA stato corrente ogni secondo
    - [x] preleva una quantità di energia da ENERGY_DEMAND
  
- [x] processo atomo       (mantenere privato il numero atomico di ciascun processo)
...
- [x] processo alimentatore
    - [x] timer di STEP_ALIMENTAZIONE nanosecondi 
    - [x] creazione di N_NUOVI_ATOMI
